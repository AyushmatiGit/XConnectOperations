...
<html lang="en">
  ...
  <form method="post" runat="server" id="mainform">
    <div id="MainPanel">
        ...
        <br>
        Contact Identificator: <asp:TextBox ID="contactName" runat="server" /> 
        ...
        <h3>Load contact</h3>
        <br>
        Contact ID: <asp:TextBox ID="contactId" runat="server" /> 
        ...
        Entrie: <asp:TextBox ID="contactPhoneEntrie" runat="server" /><br>
        CountryCode: <asp:TextBox ID="contactPhoneCountryCode" runat="server" /><br>
        Number: <asp:TextBox ID="contactPhoneNumber" runat="server" /><br>
        Extension: <asp:TextBox ID="contactPhoneExtension" runat="server" /><br>
        ...
        <tr>
            <td>
                ...
                <br>
                Entrie: <asp:TextBox ID="contactEmailEntrie" runat="server" /><br>
                Email: <asp:TextBox ID="contactEmailEmail" runat="server" Text=""/><br>
        ...
        <tr>
            <td>
                <h4>IContactAddresses</h4><br>
                Entrie: <asp:TextBox ID="contactAddressEntrie" runat="server" /><br>
                Country: <asp:TextBox ID="contactAddressCountry" runat="server" /><br>
                City: <asp:TextBox ID="contactAddressCity" runat="server" /><br>
                PostalCode: <asp:TextBox ID="contactAddressPostalCode" runat="server" /><br>
                StateProvince: <asp:TextBox ID="contactAddressStateProvince" runat="server" /><br>
                StreetLine1: <asp:TextBox ID="contactAddressStreetLine1" runat="server" /><br>
                Location.Longitude: <asp:TextBox ID="contactAddressLongitude" runat="server" /><br>
                Location.Latitude: <asp:TextBox ID="contactAddressLatitude" runat="server" /><br>
            ...
            <tr>
                <td>
                    ...
                    <br>
                    Title: <asp:TextBox ID="contactPersonalTitle" runat="server" /><br>
                    FirstName: <asp:TextBox ID="contactPersonalFirstName" runat="server" /><br>
                    MiddleName: <asp:TextBox ID="contactPersonalMiddleName" runat="server" /><br>
                    Surname: <asp:TextBox ID="contactPersonalSurname" runat="server" /><br>
                    Suffix: <asp:TextBox ID="contactPersonalSuffix" runat="server" /><br>
                    Gender: <asp:TextBox ID="contactPersonalGender" runat="server" /><br>
                    JobTitle: <asp:TextBox ID="contactPersonalJobTitle" runat="server" /><br>
